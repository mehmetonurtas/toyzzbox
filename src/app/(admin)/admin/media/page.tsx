...
//   const buttonDisabled = name.length < 1 || loading;
...
//       setStatusMessage("All files uploaded successfully, creating post...");
//       await createBrand({ name, description, mediaIds });
...
// <div className="flex gap-4 items-start pb-4 w-full">
//   {/* Dosya önizlemeleri için container */}
//   <div className="flex flex-wrap gap-2">
//     {fileUrls.map((url, index) => (
//       <div 
//         key={index}
...
//         <div className="flex justify-between items-center mt-5">
//           <div className="text-neutral-500">Characters: {name.length}</div>
//           <button
//             type="submit"
//             className={twMerge(
